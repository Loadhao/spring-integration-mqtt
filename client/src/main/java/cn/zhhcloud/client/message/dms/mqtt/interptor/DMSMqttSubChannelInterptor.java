 ...
 */
@Slf4j
public class DMSMqttSubChannelInterptor extends MqttChannelInterptor {

    @Override
    public void afterSendCompletion(Message<?> message, MessageChannel channel, boolean sent, Exception ex) {
        log.info("DMSMqttSubscriber received message completion, message:{}, channel{}, send:{}, ex:{}", message, channel, sent, ex);
    }
}
